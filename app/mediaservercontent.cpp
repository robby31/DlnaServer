...
MediaServerContent::MediaServerContent(MediaRendererModel *model, UpnpObject *upnpParent, QString host, int port, QObject *parent):
    ServiceContentDirectory(upnpParent, parent),
...
MediaServerContent::~MediaServerContent()
{
...
void MediaServerContent::_addFolder(const QString &folder)
{
...
void MediaServerContent::folderAddedSlot(QString folder)
{
    listFolderAdded << folder;
}

void MediaServerContent::reloadLibrary()
{
    emit reloadLibrarySignal(listFolderAdded);
}

void MediaServerContent::streamReadyToOpen()
{
    Device *stream = qobject_cast<Device*>(sender());
    stream->open();
}

void MediaServerContent::readTimeSeekRange(const QString &data, qint64 *start, qint64 *end)
{
...
void MediaServerContent::servingFinished(QString host, QString filename, int status)
{
    Q_UNUSED(host)
...
void MediaServerContent::servingMedia(QString filename, int playedDurationInMs)
{
...
DlnaResource *MediaServerContent::getDlnaResource(const QString &hostaddress, const QString &objId)
{
...
void MediaServerContent::dlnaContentUpdated()
{
...
void MediaServerContent::mediaRendererDestroyed(const QString &hostaddress)
{
...
bool MediaServerContent::replyAction(HttpRequest *request, const SoapAction &action)
{
    ...
    {
        return ServiceContentDirectory::replyAction(request, action);
    }
}

bool MediaServerContent::replyRequest(HttpRequest *request)
{
    if (ServiceContentDirectory::replyRequest(request))
        return true;
